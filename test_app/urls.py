...
urlpatterns = [
    ...
    path(
        'update_trip_detail/<int:pk>/<str:name>/<str:detail>/<str:position_start>/<str:position_end>/<int:budget>/<int:permission>/<str:username>/<str:date_end>/<str:date_start>/', 
         TripDetailUpdateDeleteAV.as_view(), 
